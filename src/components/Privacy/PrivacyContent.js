		...
		<div>
			<div className="max-w-4xl mx-auto lg:px-10 px-5 py-[10rem] text-[#2F3435] font-helvetica">
				...
				<ul className="list-disc lg:text-[18px] font-light text-[15px] pl-6 space-y-2 text-sm leading-relaxed">
					...
					<li>Technical Data: IP address, browser type, device information, operating system, and website usage data.</li>
					<li>Communication Records: Emails, messages, customer support interactions, and feedback.</li>
					<li>Marketing Preferences: Details of your preferences in receiving marketing communications from us.</li>
				...
				<ul className="list-disc lg:text-[18px] font-light text-[15px] pl-6 space-y-2 text-sm leading-relaxed">
					...
					<li>From third parties, such as payment processors, advertising networks, analytics providers, and business partners.</li>
				...
				<ul className="list-disc lg:text-[18px] font-light text-[15px] pl-6 space-y-2 text-sm leading-relaxed">
					...
					<li>To analyze website traffic, optimize user engagement, and conduct market research.</li>
					<li>To comply with legal obligations and prevent fraudulent activities.</li>
					<li>To send promotional offers, newsletters, and advertisements based on user preferences.</li>
					<li>To provide security monitoring and fraud prevention.</li>
					<li>To improve our website functionality and enhance customer experience.</li>
					<li>To enforce our terms of service, policies, and business agreements</li>
				...
				<ul className="list-disc lg:text-[18px] font-light text-[15px] pl-6 space-y-2 text-sm leading-relaxed">
					...
					<li>
						Business Transfers: In the event of a merger, acquisition, or sale of assets, customer information may be transferred to the new entity.</li>
					<li>Affiliated Companies: If we have subsidiaries or affiliates, we may share data within our corporate structure.</li>
				</ul>
				...
				<ul className="list-disc lg:text-[18px] font-light text-[15px] pl-6 space-y-2 text-sm leading-relaxed">
					...
					<li>To personalize user experience and improve our services.Cookie Control: Manage cookie settings through browser preferences.</li>
				...
				<ul className="list-disc lg:text-[18px] font-light text-[15px] pl-6 space-y-2 text-sm leading-relaxed">
					...
					<li>
						Store user preferences.</li>
					<li>Users can modify their cookie preferences through browser settings. Disabling cookies may affect.</li>
				...
				<p className="lg:text-[18px] font-light text-[15px] leading-relaxed">
					...
					Phone: +91 7027029188, +91 7027028892 <br />
					Address: First floor, Pipli Road, Adjoining Chattha Complex, Near Heritage Hotel, Kurukshetra, 136118, Haryana <br />
				</p>
