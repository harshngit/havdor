		...
		<>
			...
			<div className='w-full lg:h-[432px] h-auto py-5 px-5 flex justify-center items-center gap-[38px] flex-col'>
				<div className='flex flex-col justify-start items-start gap-5'>
					...
					<div className='lg:w-[720px] w-full'>
						<p className='text-[20px] font-helvetica text-lightgrey font-thin tracking-wide'>At At Hav’dor, we strive to become the most trusted name in engineered wooden doors across India by oﬀering strong, elegant and long-lasting soundproof doors. With smart design, eco-friendly materials and high customization, we aim to have a Hav’dor door in every Indian home	.</p>
					</div>
				</div>
			</div>
		</>
