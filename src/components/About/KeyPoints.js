				...
				<div className='w-full hidden lg:grid lg:grid-cols-4 grid-cols-1 gap-5'>
					...
					<div className='flex flex-col justify-start items-start gap-5'>
						...
						<div className='flex justify-start flex-col items-start gap-5'>
							<h4 className='font-semibold font-helvetica text-[20px] text-white'>Quality Variability</h4>
					...
					<div className='flex justify-start flex-col items-start gap-5'>
						...
						<div className='flex justify-start flex-col items-start gap-5'>
							<h4 className='font-semibold font-helvetica text-[20px] text-white'>Time-Consuming</h4>
					...
					<div className='flex justify-start flex-col items-start gap-5'>
						...
						<div className='flex justify-start flex-col items-start gap-5'>
							<h4 className='font-semibold font-helvetica text-[20px] text-white'>Higher Labor Costs</h4>
							<p className='font-thin font-helvetica text-[18px] text-white'>
					...
					<div className='flex justify-start flex-col items-start gap-5'>
						...
						<div className='flex justify-start flex-col items-start gap-5'>
							<h4 className='font-semibold font-helvetica text-[20px] text-white'>Design Limitations</h4>
